    ...
    public Tile createTile(int mapIcon) { 
        ...
        switch (mapIcon) { 
            ...
            case 231:
                ...
                tile = new Tile("letters/L_A.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;
                
            case 232:
                
                tile = new Tile("letters/L_B.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;
            
             case 233:
                
                tile = new Tile("letters/L_C.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;    
                
             case 234:
             
                tile = new Tile("letters/L_D.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;
                
             case 235:
             
                tile = new Tile("letters/L_E.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
             
                break;
                
              case 236:
              
                tile = new Tile("letters/L_F.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
              
                break;
                
             case 237:
             
                tile = new Tile ("letters/L_G.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;
                
             case 238:  
                
                tile = new Tile ("letters/L_H.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;
                
             case 239:   
                
                tile = new Tile ("letters/L_I.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;   
                
              case 240: 

                tile = new Tile("letters/L_J.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT); 

                break; 

            case 241: 

                tile = new Tile("letters/L_K.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT); 

                break; 

            case 242: 

                tile = new Tile("letters/L_L.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT); 

                break; 

            case 243: 

                tile = new Tile("letters/L_M.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT); 

                break; 

            case 244: 

                tile = new Tile("letters/L_N.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT); 

                break; 

            case 245: 

                tile = new Tile("letters/L_O.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT); 

                break; 

            case 246: 

                tile = new Tile("letters/L_P.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT); 

                break; 

            case 247: 

                tile = new Tile("letters/L_Q.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT); 

                break; 

            case 248:
                
                tile = new Tile("letters/L_R.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;
                
            case 249:
                
                tile = new Tile("letters/L_S.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;
            
             case 250:
                
                tile = new Tile("letters/L_T.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;    
                
             case 251:
             
                tile = new Tile("letters/L_U.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;
                
             case 252:
             
                tile = new Tile("letters/L_V.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
             
                break;
                
              case 253:
              
                tile = new Tile("letters/L_W.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
              
                break;
                
             case 254:
             
                tile = new Tile ("letters/L_X.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;
                
             case 255:  
                
                tile = new Tile ("letters/L_Y.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                
                break;
                
             case 256:   
                
                tile = new Tile ("letters/L_Z.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
